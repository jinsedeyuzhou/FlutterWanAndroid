...
class ItemSearchArticle extends StatelessWidget with NBaseWidgetMixin {
                ...
                children: <Widget>[
                  ...
                  if (article.envelopePic.isEmpty)
                    Padding(
                      ...
                      child: SearchArticleTitleWidget(article.title),
                    )
                  else
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: <Widget>[
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget>[
                              SearchArticleTitleWidget(article.title),
                              const SizedBox(
                                height: 2,
                              ),
                              Text(
...
class SearchArticleTitleWidget extends StatelessWidget {
  final String title;

  SearchArticleTitleWidget(this.title, {super.key});
